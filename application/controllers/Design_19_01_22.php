...
$appCount=0;
			...
			<div class="badge  badge-success mt-1" title="Order Approved"><i class="fa fa-thumbs-up"></i> '.$appCount.'</div>
			<div class="badge  badge-danger" title="Order Rejected"><i class="fa fa-thumbs-down"></i> '.$rejCount.'</div>
			</td>';
