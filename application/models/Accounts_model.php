...
class Accounts_model extends CI_Model{
	...
	public function get_all_completed_works($orderform_type_id,$selectBy){
			$wh =array();
			$SQL ='SELECT 	
			...
			$wh[] = " wo_work_orders.order_id != 0 AND wo_work_orders.orderform_type_id='$orderform_type_id' and wo_work_orders.production_completed_status=1 ";
			if($selectBy=="approved"){ $wh[] ="wo_work_orders.accounts_completed_status=1"; }
			if($selectBy=="approve"){ $wh[] ="wo_work_orders.accounts_completed_status=0"; }
