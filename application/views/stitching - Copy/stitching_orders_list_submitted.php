...
function ApproveOrDeny(status){
	...
	var table = $('#listing').DataTable( {
      	"processing": true,
      	"serverSide": true,
      	"ajax": "<?=base_url('stitching/order_submitted')?>",
     	"order": [[0,'desc']],
      "columnDefs": [
        { "targets": 0, "name": "WO.orderform_number", 'searchable':true, 'orderable':true},
        { "targets": 1, "name": "SH.schedule_c_date", 'searchable':true, 'orderable':true},
		...
		{ "targets": 6, "name": "wo_product_info", 'searchable':false, 'orderable':false,className:'text-center'},
