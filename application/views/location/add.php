...
<p class="card-description" style="border-bottom: 1px solid #f2f2f2;">Add New Location  </p>


<?php echo form_open(base_url('location/add'), 'class="cmxform"  id="dataform" method="post"'); ?>
...
<div class="col-lg-9"><input class="form-control"  name="location_name" id="location_name" type="text"  value="" required=""></div>
</div>
