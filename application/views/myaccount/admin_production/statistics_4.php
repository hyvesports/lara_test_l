        ...
        <div class="row">
          ...
          <div class="col-md-12 pl-md-1 pt-4 pt-md-0">
            ...
            <ul class="nav nav-tabs tab-basic" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="design-p-tab" data-toggle="tab" href="#designp" role="tab" aria-controls="designp" aria-selected="true">Pending</a>
              </li>
          <!--     <li class="nav-item">
		 <a class="nav-link active" id="design-c-tab" data-toggle="tab" href="#designc" role="tab" aria-controls="designc" aria-selected="false">Today</a>
              ...
              <div class="tab-content tab-content-basic">
                <div class="tab-pane fade show active" id="designp" role="tabpanel" aria-labelledby="design-p-tab">
...
<div class="clearfix"></div>
        <div class="row">
          ...
          <div class="col-md-12 pl-md-1 pt-4 pt-md-0">
            ...
            <ul class="nav nav-tabs tab-basic" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="designqc-p-tab" data-toggle="tab" href="#designqcp" role="tab" aria-controls="designqcp" aria-selected="true">Pending</a>
              </li>
              <!-- <li class="nav-item">
		 <a class="nav-link active" id="designqc-c-tab" data-toggle="tab" href="#designqcc" role="tab" aria-controls="designqcc" aria-selected="false">Today</a>
            ...
            <div class="tab-content tab-content-basic">
              <div class="tab-pane fade show active" id="designqcp" role="tabpanel" aria-labelledby="designqc-p-tab">
...
<div class="clearfix"></div>
        <div class="row">
          <div class="col-md-12 pl-md-1 pt-4 pt-md-0">
            ...
            <ul class="nav nav-tabs tab-basic" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="printing-p-tab" data-toggle="tab" href="#printingp" role="tab" aria-controls="printingp" aria-selected="true">Pending</a>
              </li>
              <!--    <li class="nav-item">
		 <a class="nav-link active" id="printing-c-tab" data-toggle="tab" href="#printingc" role="tab" aria-controls="printingc" aria-selected="false">Today</a>
            ...
            <div class="tab-content tab-content-basic">
              <div class="tab-pane fade show active" id="printingp" role="tabpanel" aria-labelledby="printing-p-tab">
