...
<div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><?php echo $year;?> MONTHLY REVENUE BAR CHART</h4>
...
<?php
$month1=$this->myaccount_model->get_leads_statistics_graph_gem(1,$year);
$gTotal_1=0;
$aTotal_1=0;
...
$month2=$this->myaccount_model->get_leads_statistics_graph_gem(2,$year);
$gTotal_2=0;
$aTotal_2=0;
...
$month3=$this->myaccount_model->get_leads_statistics_graph_gem(3,$year);
$gTotal_3=0;
$aTotal_3=0;
...
$month4=$this->myaccount_model->get_leads_statistics_graph_gem(4,$year);
$gTotal_4=0;
$aTotal_4=0;
...
$month5=$this->myaccount_model->get_leads_statistics_graph_gem(5,$year);
$gTotal_5=0;
$aTotal_5=0;
...
$month6=$this->myaccount_model->get_leads_statistics_graph_gem(6,$year);
$gTotal_6=0;
$aTotal_6=0;
...
$month7=$this->myaccount_model->get_leads_statistics_graph_gem(7,$year);
$gTotal_7=0;
$aTotal_7=0;
...
$month8=$this->myaccount_model->get_leads_statistics_graph_gem(8,$year);
$gTotal_8=0;
$aTotal_8=0;
...
$month9=$this->myaccount_model->get_leads_statistics_graph_gem(9,$year);
$gTotal_9=0;
$aTotal_9=0;
...
$month10=$this->myaccount_model->get_leads_statistics_graph_gem(10,$year);
$gTotal_10=0;
$aTotal_10=0;
...
$month11=$this->myaccount_model->get_leads_statistics_graph_gem(11,$year);
$gTotal_11=0;
$aTotal_11=0;
...
$month12=$this->myaccount_model->get_leads_statistics_graph_gem(12,$year);
$gTotal_12=0;
$aTotal_12=0;
