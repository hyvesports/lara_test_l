<iv class="container-fluid page-body-wrapper">
...
//$date_filter=date("Y-m-d",strtotime($this->session->userdata('date_now')));
$date_filter=date("Y-m-d");
$leadArray=$this->myaccount_model->get_leads_statistics_admin($month,$year);
$orderArray = $this->myaccount_model->get_order_statistics_new_admin($month,$year);
$orderRecArray = $this->myaccount_model->get_amount_to_rec_by_sales_admin($month,$year);

?>

<?php include('admin/statistics_1.php');?>
<?php include('admin/statistics_2.php');?>
<?php $woArrayGem=$this->myaccount_model->get_wo_statistics_for_all($year,$month); ?>
<?php include('admin/statistics_4.php');?>
<?php include('admin/statistics_3.php');?>
<?php include('admin/statistics_5.php');?>
