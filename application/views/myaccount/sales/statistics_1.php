...
<div class="col-md-12 grid-margin transparent">
    <div class="row">
        ...
        <p class="fs-30 mb-2"><?php echo $orderArray['order_total'];?></p>
         <p>From <strong><?php echo $leadArray['total_leads'];?></strong> Leads</p>
        </div>
        </div>
        </div>
        ...
        <p>From <strong><?php echo $orderRecArray['total_orders'];?></strong> Orders</p>
        </div>
        </div>
        </div>
