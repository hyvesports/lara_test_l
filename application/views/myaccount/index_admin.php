<div class="content-wrapper">
			...
			$tasks=$this->myaccount_model->get_my_tasks($loginid);
			if($tasks){
			?>
            <div class="row">
            ...
            <td><a href="<?php echo base_url('leads/view/'.$TSK['lead_uuid']);?>"  style="cursor: pointer;" target="_blank"><label class="badge badge-warning" style="cursor: pointer;"> <?php echo $TSK['lead_code'];?></label></a>
            ...
            <div class="d-flex align-items-center">
                              ...
                              <div class="">
                                ...
                                <p class="mb-2"><?php echo $TSK['customer_name'];?></p>
                                <p class="mb-0 text-muted text-small"><?php echo $TSK['customer_mobile_no'];?><br/> <?php echo $TSK['customer_email'];?></p>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex border-bottom pb-3">
                    ...
                    <img src="images\faces\face10.jpg" class="img-sm mr-4 rounded-circle" alt="profile">
                  ...
                  <div class="d-flex border-bottom py-3">
                    ...
                    <img src="images\faces\face12.jpg" class="img-sm mr-4 rounded-circle" alt="profile">
                  ...
                  <div class="d-flex border-bottom py-3">
                    ...
                    <img src="images\faces\face5.jpg" class="img-sm mr-4 rounded-circle" alt="profile">
                  ...
                  <div class="d-flex pt-3">
                    ...
                    <img src="images\faces\face8.jpg" class="img-sm mr-4 rounded-circle" alt="profile">
              ...
              <div class="card bg-primary text-white card-update">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex border-light-white pb-4 update-item">
                    ...
                    <img src="images\faces\face12.jpg" alt="profile" class="img-sm rounded-circle img-bordered mr-4">
                    ...
                    <div>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="rounded-circle image-layer-item" src="images\faces\face3.jpg" alt="profile">

                        <img class="rounded-circle image-layer-item" src="images\faces\face5.jpg" alt="profile">

                        <img class="rounded-circle image-layer-item" src="images\faces\face8.jpg" alt="profile">
                  ...
                  <div class="d-flex pt-4 update-item">
                    ...
                    <img src="images\faces\face14.jpg" alt="profile" class="img-sm rounded-circle img-bordered mr-4">
                    ...
                    <div>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="rounded-circle image-layer-item" src="images\faces\face9.jpg" alt="profile">

                        <img class="rounded-circle image-layer-item" src="images\faces\face11.jpg" alt="profile">

                        <img class="rounded-circle image-layer-item" src="images\faces\face13.jpg" alt="profile">
