...
?>
<?php include('production/statistics_1.php');?>
<?php include('production/statistics_2.php');?>
<?php include('production/statistics_3.php');?>
<?php include('production/statistics_4.php');?>
<?php include('production/statistics_5.php');?>

<?php include('production/statistics_6.php');?>
</div>
