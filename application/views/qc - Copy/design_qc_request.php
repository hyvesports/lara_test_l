...
<?php endif; ?>
<h4 class="card-title"><?php echo $title;?> | design Request
...
<a class="btn btn-info " href="<?=base_url('myaccount/myorders/request/')?>">Approval Request</a>
</p>
...
function ApproveOrDeny(status){
	...
	var table = $('#listing').DataTable( {
      	"processing": true,
      	"serverSide": true,
      	"ajax": "<?=base_url('qc/design_qc_request')?>",
     	"order": [[0,'desc']],
      "columnDefs": [
