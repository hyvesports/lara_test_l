...
<div class="row profile-page">
   ...
   <?php $options=$this->myaccount_model->get_order_options($row['order_id'],$value1['summary_id']); ?>
    ...
    <?php
	$qc_result=$this->bundling_model->check_bundling_completed_new($value1['summary_id'],'fusing');
	if($qc_result['rs_design_id']){ ?>
    
    	<div class="alert alert-success" role="alert">Order Submitted to Stitching  on <?php echo $qc_result['submitted_datetime'];?></div>
        <?php 
