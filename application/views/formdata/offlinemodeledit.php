...
$refData = $this->formdata_model->get_summary_draft_data($offline_draft_id);
//print_r($refData);
?>
<?php $options = $this->formdata_model->get_all_order_options_latest($refData['current_form_id'],$refData['current_login_id'],$offline_draft_id); ?>
<form action="post" id="mform">
<input type="hidden" name="offline_draft_id" id="offline_draft_id" value="<?php echo $offline_draft_id;?>" />
...
<div class="row">
	...
	if($refData['item_addons']!=""){
		$wo_item_addons=explode(",",$refData['item_addons']);
	}
	?>
    <div class="col-md-2">
    <label>Add-ons</label>
...
$.post('<?= base_url("formdata/offline_ajax_post_edit/");?>', $("#mform").serialize(), function(data) {
