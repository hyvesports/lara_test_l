...
<div class="col-md-8">
<input name="wo_shipping_cost" id="wo_shipping_cost" type="text" class="form-control  required number" onkeyup="calculateAmount();"  maxlength="10" value="0"  />
</div>
</div>
</div>
<div class="col-md-6">
...
<div class="col-md-8">
<input type="text" class="form-control number" name="wo_additional_cost" id="wo_additional_cost" maxlength="8"  value="0" onkeyup="calculateAmount();" >
</div>
</div>
</div>
<div class="col-md-12">
...
<div class="col-md-8">
<input type="text" class="form-control number" name="wo_adjustment" id="wo_adjustment" maxlength="5"  value="0" onkeyup="calculateAmount();" >
</div>
</div>
</div>
<div class="col-md-4" >
...
<div class="col-md-6">
<input type="text" class="form-control required number" name="wo_gross_cost" id="wo_gross_cost" maxlength="10"  value="<?php echo $sumRows['totalRate']-$sumRows['totalDiscount'];?>" readonly="readonly">
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="col-md-6">
<input type="text" class="form-control required number" name="wo_advance" id="wo_advance" maxlength="8"  value="0" onkeyup="calculateAmount();">
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="col-md-6">
<input type="text" class="form-control number" name="wo_balance" id="wo_balance" maxlength="50"  value="<?php echo $sumRows['totalRate']-$sumRows['totalDiscount'];?>" readonly="readonly">
</div>
</div>
</div>
</div>  
