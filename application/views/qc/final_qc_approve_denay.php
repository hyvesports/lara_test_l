...
<div class="card-body">
				...
				<input type="hidden" name="hidden_schedule_id" id="hidden_schedule_id" value="<?php echo $rsRowData['schedule_id'];?>" />
				<input type="hidden" name="hidden_schedule_department_id" id="hidden_schedule_department_id" value="<?php echo $rsRowData['schedule_department_id'];?>" />
				<input type="hidden" name="hidden_rs_design_id" id="hidden_rs_design_id" value="<?php echo $rsRowData['rs_design_id'];?>" />
				<input type="hidden" name="hidden_summary_id" id="hidden_summary_id" value="<?php echo $rsRowData['summary_item_id'];?>" />
                <?php if($_POST['afor']=="-1"){ ?>
