...
<?php endif; ?>
<h4 class="card-title"><?php echo $title;?> | pending</h4>
<div class="row">
...
<table id="listing" class="table w-100" >
<thead>
<tr>
<th width="10%">Scheduled Date</th>
<th width="10%">#Order</th>
<th width="10%">Timestamp</th>
<th width="10%">Disp: Date</th>
<th width="10%">Sales Handler</th>
...
<script>
	...
	var table = $('#listing').DataTable( {
		...
		"pageLength": 25,
		"bInfo" : false,
      	"ajax": "<?=base_url('qc/list_works_qc/pending')?>",
     	"order": [[0,'desc']],
      "columnDefs": [
