...
<p class="card-description" style="border-bottom: 1px solid #f2f2f2;">Add New Lead Stage</p>

<?php echo form_open(base_url('leadstage/add'), 'class="cmxform"  id="dataform" method="post"'); ?>
...
<div class="col-lg-9">
<input class="form-control required"  name="lead_stage_name" id="lead_stage_name" type="text"  value="<?php echo $this->input->post('lead_stage_name');?>" required="">
</div>
</div>
...
<option value="1" <?php if($this->input->post('lead_stage_status')==1){ echo 'selected="selected"'; } ?> >Active</option>
<option value="0" <?php if($this->input->post('lead_stage_status')==0){ echo 'selected="selected"'; } ?>>InActive</option>
</select>
</div>
</div>
