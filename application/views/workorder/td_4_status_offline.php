		...
		if(!$rejectionRow4){
			...
			<?php if($lastRow4['rs_design_id']!="" ){ ?>
				<?php if($lastRow4['schedule_department_id']==$sArray4['schedule_department_id']){  ?>
    				...
    				<li><strong class="text-warning"><i class="fa fa-thumbs-down mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
					<?php }else{ ?>
					<li><strong class="text-warning"><i class="fa fa-arrow-circle-right mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
					<?php } ?>
					<!---------------------------------------------------------------------------------------------------------------------------------------->
				<?php }else if($lastRow4['schedule_department_id']!= $sArray4['schedule_department_id']){ ?>
					...
					<!---------------------------------------------------------------------------------------------------------------------------------------->
 					<?php if($lastRow4['verify_status']==1){?>
    				<li><strong class="text-success"><i class="fa fa-minus mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
					<?php }else if($lastRow4['verify_status']==-1){?>
    				<li><strong class="text-warning"><i class="fa fa-arrow-circle-left mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
					<?php }else{ ?>
					<li><strong class="text-success"><i class="fa fa-minus mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
					<?php } ?>
					<!---------------------------------------------------------------------------------------------------------------------------------------->
			...
			<?php } ?>
		<?php }else{ ?>
			<li><strong class="text-danger" title="Rejected By : <?php echo ucwords($rejectionRow4['rejected_from_departments']);?>"><i class="fa fa-thumbs-down mr-1"></i><?php echo ucwords($value4['product_type']);?> [<?php echo ucwords($rejectionRow4['rejected_qty']);?>/<?php echo ucwords($value4['item_unit_qty_input']);?>][S<?php echo $thisSchedule4;?>]</strong></li>
		<?php } ?>
	<?php }} ?>
<?php } ?>
</ol>
