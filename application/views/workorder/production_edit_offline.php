...
<?php echo form_open(base_url('work/production_edit/'.$woRow['order_uuid']), 'class="cmxform"  id="dataform" method="post"'); ?>
...
<div class="form-group row">
        ...
        <td><?php echo $item['wo_addon_name'];?>(<?php echo $item['wo_addon_value'];?>)</td>
        <td><?php echo $item['wo_qty'];?></td>
        <td><?php echo $item['wo_rate'];?>
        <input type="hidden" class="form-control text-center required number rateClass" id="wo_rate<?php echo $inc;?>" name="wo[<?php echo $inc;?>][wo_rate]" readonly="readonly" value="<?php echo $item['wo_rate'];?>" >
        </td>
        <td><?php echo $item['wo_discount'];?>
        <input type="hidden" class="form-control text-center number discountClass" id="wo_discount<?php echo $inc;?>" name="wo[<?php echo $inc;?>][wo_discount]" onkeyup="calculateRow(<?php echo $inc;?>);" value="<?php echo $item['wo_discount'];?>">
        </td>
