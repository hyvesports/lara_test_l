				...
				<?php if($lastRow8['schedule_department_id']==$sArray8['schedule_department_id']){  ?>
					...
					<?php if($lastRow8['submitted_to_accounts']==1 && $lastRow8['accounts_status']==0){?>
						<?php if($lastRow8['verify_status']==1){?>
                        	<li><strong class="text-warning"><i class="fa fa-minus mr-1"></i><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</strong></li>
                        <?php }else if($lastRow8['verify_status']==-1){?>
                        	<li><strong class="text-warning"><i class="fa fa-thumbs-down mr-1"></i><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</strong></li>
                        <?php }else{ ?>
                        	<li><strong class="text-warning"><i class="fa fa-arrow-circle-right mr-1"></i><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</strong></li>
                        <?php } ?>
					<?php }else if($lastRow8['submitted_to_accounts']==1 && $lastRow8['accounts_status']==1){ ?>
							...
							<?php if($anyDispatch['dispatch_counts']=="0"){ ?>
								<li><strong class="text-warning"><i class="fa fa-thumbs-up mr-1"></i><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</strong></li>
							<?php }else{ ?>
								<li><strong class="text-success"><i class="fa fa-thumbs-up mr-1"></i><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</strong></li>
							<?php } ?> 							
						 	
					<?php }else{ ?>
							<li><?php echo ucwords($value8['product_type']);?> [<?php echo ucwords($value8['item_unit_qty_input']);?>][S<?php echo $thisSchedule8;?>]</li>
					<?php } ?>
