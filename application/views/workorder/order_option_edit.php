...
<?php foreach($options as $OP) {?>
    ...
    <td><input type="text" class="form-control text-left  number" id="option_number<?php echo $inc;?>" name="options[<?php echo $inc;?>][option_number]" value="<?php echo $OP['option_number'];?>"></td>
    <td>
    ...
    <td><input type="text" class="form-control text-center digits required" id="option_qty<?php echo $inc;?>" name="options[<?php echo $inc;?>][option_qty]" value="<?php echo $OP['option_qty'];?>" ></td>
...
function addFilterOptionRow(){
	...
	html+='<td><input type="text" class="form-control text-center  number" id="option_qty'+filter_row+'" name="options['+filter_row+'][option_qty]"  ></td>';
