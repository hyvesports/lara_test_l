...
<td><input type="text" class="form-control text-center digits required" id="option_qty0" name="options[0][option_qty]" ></td>
...
function addFilterOptionRow(){
	...
	<?php } ?>
	html+='</select></td>';
html+='<td><input type="text" class="form-control text-center  digits required" id="option_qty'+filter_row+'" name="options['+filter_row+'][option_qty]"  ></td>';
