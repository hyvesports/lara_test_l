...
<div class="row">
                    <div class="col-md-12">
                      <address>
                        <p class="font-weight-bold m-2"><?php echo $item['summary_client_name'];?> </p>
                        <p class="m-1">Ref: No: <?php echo $item['wo_ref_no'];?>  </p>
                        <p class="m-1">Shipping Type : <?php echo $item['shipping_type_name'];?></p>
                        <p class="m-1">Shipping Address : <?php echo $item['wo_shipping_address'];?></p>
                      </address>
                    </div>
...
<tr>
    <td class="py-1 pl-0" valign="top" width="80%">
    <div class="d-flex align-items-center">
    <div class=" mb-3"><strong class=" mb-3"><?php echo $inc;?>.<?php echo ucwords($item['wo_product_type_name']);?></strong>
<span class="badge badge-outline-warning">#<?php echo $item['wo_ref_no'];?></span><br/>
<p></p>
