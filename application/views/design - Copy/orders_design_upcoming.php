...
<?php endif; ?>
<h4 class="card-title"><?php echo $title;?> | upcoming
...
<a class="btn btn-info " href="<?=base_url('myaccount/myorders')?>">Active</a>
<a class="btn btn-warning " href="<?=base_url('myaccount/myorders/upcoming/')?>">Upcoming</a>
<a class="btn btn-success " href="<?=base_url('myaccount/myorders/approved/')?>">Approved</a>
...
<script>
	...
	var table = $('#listing').DataTable( {
      	"processing": true,
      	"serverSide": true,
      	"ajax": "<?=base_url('design/design_orders_upcoming')?>",
     	"order": [[0,'asc']],
      "columnDefs": [
		...
		{ "targets": 4, "name": "PO.production_unit_name", 'searchable':true, 'orderable':false,className:'text-center'},
		{ "targets": 5, "name": "WO.wo_product_info", 'searchable':true, 'orderable':false,className:'text-center'},
		{ "targets": 6, "name": "WO.wo_product_info", 'searchable':true, 'orderable':false,className:'text-center'},
