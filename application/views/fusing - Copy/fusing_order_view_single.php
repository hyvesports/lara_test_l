...
<div class="row profile-page">
   ...
   <?php $options=$this->myaccount_model->get_order_options($row['order_id'],$value1['summary_id']); ?>
	...
	?>
	<span class="badge badge-outline-danger w-100 mt-4" ><?php echo $any_rejection['rejected_department'];?> Rejected :<?php echo $any_rejection['verify_remark'];?> <br><?php echo $any_rejection['verify_datetime'];?></span>
	<?php
	}
	?>
