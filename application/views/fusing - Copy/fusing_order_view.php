...
<div class="row profile-page">
   ...
   <?php $options=$this->myaccount_model->get_order_options($row['order_id'],$value1['summary_id']); ?>
    ...
    <?php
	//echo 1;
	$qc_result=$this->fusing_model->check_printing_deptmt_submitted($value1['summary_id'],'printing');
	if($qc_result['rs_design_id']==""){ ?>
    <div class="alert alert-danger" role="alert">Printing Department Not Submitted </div>
    <?php }else{ ?>
    <div class="alert alert-success" role="alert">Printing Department Submitted on <?php echo $qc_result['verify_datetime'];?></div>
	...
	?>
        ...
        and qc_name='fusing' ORDER BY rs_design_id DESC LIMIT 1 ";
        //echo $sel;
