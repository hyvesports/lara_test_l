...
<?php echo form_open(base_url('leads/task/'.$lead_info['lead_uuid']), 'class="cmxform"  id="taskForm" method="post"'); ?>
    ...
    <label>Task <span class="text-danger">*</span></label>
     <input type="text" class="form-control required" name="task_desc" id="task_desc"   >
    </div>
    <div class="col-md-3">
    <label>Reminder Date <span class="text-danger">*</span></label>
    <div class="input-group date" id="datepicker" data-target-input="nearest">
    <div class="input-group" data-target="#datepicker" data-toggle="datetimepicker">
    <input type="text" class="form-control required"  name="reminder_date"  id="reminder_date" value="<?php echo date('d-m-Y');?>"/>
    <div class="input-group-addon input-group-append"><i class="icon-calendar input-group-text"></i></div>
    </div>
	</div>
    </div>
    <?php
    ...
    <input type="text" class="form-control required"  name="reminder_time"  id="reminder_time" value="<?php echo $ctimee;?>"/>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <?php foreach($all_tasks as $TSK){ ?>
                       ...
                       <em> <?php echo $TSK['reminder_date'];?>, <?php echo $TSK['reminder_time'];?></em>
                      </small></td>
