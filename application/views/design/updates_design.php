...
<input type="text" class="form-control required" id="schedules_status_url"  name="schedules_status_url"></input>
</div>
...
$(function() {
	...
	$.post('<?= base_url("design/save_updates_design/");?>', $("#updateStatusForm").serialize(), function(data) {
