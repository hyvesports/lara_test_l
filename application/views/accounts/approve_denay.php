...
$sqlSel="Select * from rs_design_departments where rs_design_id='".$_POST['rdid']."'"; 
...
<input type="hidden" name="oid" id="oid" value="<?php echo $_POST['oid'];?>" />
<?php //print_r($schedule_data); ?>
...
<ul class="d-flex flex-column-reverse todo-list">
    ...
    <?php if($jValue['summary_id']==$rsRowData['summary_item_id']){ ?>
