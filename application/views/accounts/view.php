...
<div class="row profile-page">
    ...
    <div class="card">
    <div class="card-body">
    <h4 class="card-title"><?php echo $title_head;?><span style="text-align:right; float:right;"><a class="btn btn-primary " href="<?php echo base_url('accounts/index');?>">LIST</a>
<?php if($row['accounts_completed_status']==0 && $row['production_completed_status']==1){ ?>
<a class="btn btn-warning " href="#" title="Approve" style="cursor: pointer;" data-toggle="modal" data-target="#approveDeny" data-rdid="<?php echo $row['last_rs_design_id'];?>" data-oid="<?php echo $row['order_id'];?>" data-afor="1"  ><i class="fa fa-thumbs-up" ></i> Approve</a>
<?php } ?>
<?php if($row['accounts_completed_status']==1){ ?>
...
<td colspan="2"><strong>Order Info </strong>:<?php echo $row['wo_product_info'];?></td>
    ...
    <table class="table table-striped mb-0" width="100%">
        ...
        <tr>
        <td colspan="8"><div class="alert alert-success" role="alert"><strong>Special requirement  :</strong> <?php echo $row['wo_special_requirement'];?></div></td>
        </tr>
        <?php } ?>
        </tbody>
