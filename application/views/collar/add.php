...
<p class="card-description" style="border-bottom: 1px solid #f2f2f2;">Add New Collar Type </p>


<?php echo form_open(base_url('collar/add'), 'class="cmxform"  id="dataform" method="post"'); ?>
...
<div class="col-lg-9"><input class="form-control"  name="collar_type_name" id="collar_type_name" type="text"  value="<?php echo $this->input->post('collar_type_name');?>" required=""></div>
</div>

<div class="form-group row">
<div class="col-lg-3"><label class="col-form-label">Amount *</label></div>
<div class="col-lg-4"><input class="form-control number"  name="collar_amount" id="collar_amount" type="text"  value="<?php echo $this->input->post('collar_amount');?>" required="" maxlength="10" min='0'></div>
</div>

<div class="form-group row">
<div class="col-lg-3"><label class="col-form-label">Making Minute*</label></div>
<div class="col-lg-4"><input class="form-control number"  name="collar_making_min" id="collar_making_min" type="text"  value="<?php echo $this->input->post('collar_amount');?>" required="" maxlength="3" min='0' max="1000"></div>
</div>
