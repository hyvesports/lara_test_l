...
<?php echo form_open(base_url('productsize/add'), 'class="cmxform"  id="dataform" method="post"'); ?>
...
<div class="form-group row">
<div class="col-lg-3"><label class="col-form-label">Product Size *</label></div>
<div class="col-lg-9"><input class="form-control"  name="product_size_name" id="product_size_name" type="text"  value="<?php echo $this->input->post('product_size_name');?>" required=""></div>
</div>
