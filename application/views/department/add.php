...
<p class="card-description" style="border-bottom: 1px solid #f2f2f2;">Add New Department  </p>


<?php echo form_open(base_url('department/add'), 'class="cmxform"  id="dataform" method="post"'); ?>
<div class="form-group row">
<div class="col-lg-3"><label class="col-form-label">Department Name</label></div>
<div class="col-lg-9"><input class="form-control "  name="department_name" id="department_name" type="text"  value="" required=""></div>
</div>
...
<option value="<?php echo $PD['department_id'];?>"><?php echo $PD['department_name'];?></option>
<?php } ?>
<?php } ?>
