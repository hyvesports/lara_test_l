...
<input type="hidden" name="order_id" id="order_id" value="<?php echo $schedule_data['order_id'];?>" />
...
$(function() {
	...
	$.post('<?= base_url("stitching/save_updates/");?>', $("#updateStatusForm").serialize(), function(data) {
